<div class="position-absolute top-50 start-50 translate-middle">
    <div class="text-center">
        ...
        <p class="fs-1 fw-light">Digger</p>
        <ul class="vstack">
            <p>Use <kbd>Left</kbd>, <kbd>Right</kbd> keys to quickly navigate flows.</p>
            <p>Use <kbd>V</kbd> key to quickly switch raw data view.</p>
            <p>Use <kbd>T</kbd> key to switch color theme.</p>
